...
<!-- machid: nLThsU052OXJEdFhuSUlhRVNpclZvcXVHVzdCTlRrSWNDN1R0dnBObzJRRnRWZlpJWTl1SjRB -->

<head>
  <title><?php echo "SubRocks" ?></title>
  ...
  <script>
    ...
    yt.timing.info('e', "904821,919006,922401,920704,912806,913419,913546,913556,919349,919351,925109,919003,920201,912706");
...
<body id="ie" class="date-20120930 en_US ltr" dir="ltr">
  ...
  <form name="logoutForm" method="POST" action="/">
    ...
    <input name="session_token" type="hidden" value="Gf58Q8B3ZutLode4CQSGAfjUJbV8MTMzOTA4NzY5NkAxMzM5MDAxMjk2">
  </form>
  <!-- begin page -->
  <div id="page" class="">
    <!-- begin pagetop -->
    ...
    <div id="content-container">
      <div id="baseDiv" class="date-20120606 video-info ">
        <p class="largeText">Sorry for the interruption. We have been receiving a large volume of requests from your network. To continue with your SubRocks experience, please complete the game of Doom below.</p>
        ...
        <form method="post" action="/das_captcha?next=<?php echo $next; ?>">
          ...
          <input name="session_token" type="hidden" value="<?php echo "c"; ?>">
        </form>
  ...
  <div id="playlist-bar" class="hid passive editable" data-video-url="/watch?v=&amp;feature=BFql&amp;playnext=1&amp;list=QL" data-list-id="" data-list-type="QL">
    <div id="playlist-bar-bar-container">
      <div id="playlist-bar-bar">
        <div class="yt-alert yt-alert-naked yt-alert-success hid " id="playlist-bar-notifications">
          ...
          <div class="yt-alert-content"></div>
        </div>
    ...
    <div id="playlist-bar-tray-container">
      <div id="playlist-bar-tray" class="yt-uix-slider yt-uix-slider-fluid"><button class="yt-uix-button playlist-bar-tray-button yt-uix-button-default yt-uix-slider-prev" onclick="return false;"><img class="yt-uix-slider-prev-arrow" src="//s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" alt="Previous video"></button><button class="yt-uix-button playlist-bar-tray-button yt-uix-button-default yt-uix-slider-next" onclick="return false;"><img class="yt-uix-slider-next-arrow" src="//s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" alt="Next video"></button>
        <div class="yt-uix-slider-body">
          <div id="playlist-bar-tray-content" class="yt-uix-slider-slide">
            ...
            <ol id="playlist-bar-help">
              <li class="empty playlist-bar-help-message">Your queue is empty. Add videos to your queue using this button: <img src="//s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" class="addto-button-help"><br> or <a href="https://accounts.google.com/ServiceLogin?uilel=3&amp;service=youtube&amp;passive=true&amp;continue=http%3A%2F%2Fwww.youtube.com%2Fsignin%3Faction_handle_signin%3Dtrue%26feature%3Dplaylist%26nomobiletemp%3D1%26hl%3Den_US%26next%3D%252Fdas_captcha%253Fnext%253D%252Fuser%252FRayWilliamJohnson%252Ffeed&amp;hl=en_US&amp;ltmpl=sso">sign in</a> to load a different list.</li>
            </ol>
          </div>
  ...
  <div id="shared-addto-menu" style="display: none;" class="hid sign-in">
    <div class="addto-menu">
      ...
      <div id="addto-note-input-panel" class="menu-panel">
        ...
        </div> <button disabled="disabled" type="button" class="playlist-save-note yt-uix-button yt-uix-button-default" onclick=";return false;" role="button"><span class="yt-uix-button-content">Add note </span></button>
      </div>
  ...
  <table style="width: 180px; display: none; top: 119px; left: 8px; position: absolute;" class="gstl_0 gssb_c" cellspacing="0" cellpadding="0">
    <tbody>
      <tr>
        <td class="gssb_f"></td>
